...
export function Product({ link, title, price, discount, openModal }) {
            ...
            <div className="flex flex-col justify-center items-center w-60 bg-zinc-900 rounded-xl" data-aos='zoom-in'>
                ...
                <div className="flex flex-col justify-center items-center p-4">
                    ...
                    <div className="flex justify-center gap-2 items-center mt-2">
                        <button className="py-2 px-4 bg-cyan-400 text-zinc-900 font-bold rounded-full shadow-md hover:bg-white hover:shadow-pink-400 transition ease-in-out delay-100"
                            onClick={openModal}
                        >Comprar</button>
