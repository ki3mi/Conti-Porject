...
export default function NavBar() {
    ...
    const Lista = () => {
        const LinkStyle = 'py-4 md:px-6 transition ease-in-out delay-50 hover:[text-shadow:_6px_-1px_12px_#08C2CE] hover:scale-105 font-bold'
        return (
            <>
    ...
    return (
        <>
            ...
            <div className={`${menu ? '' : 'hidden'} bg-black w-full h-screen fixed z-20 p-4`}>
